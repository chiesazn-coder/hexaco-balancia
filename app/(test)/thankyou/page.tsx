...
const LATE_ADDED_LAUNCH_MS: Record<string, number> = { ist: IST_LAUNCH_MS, papi: PAPI_LAUNCH_MS, hexaco: REORDER_LAUNCH_MS, disc: DISC_LAUNCH_MS, "love-language": LOVE_LANGUAGE_LAUNCH_MS };
